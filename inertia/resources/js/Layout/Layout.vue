  ...
  <main>
    ...
    <div class="min-h-full">
      <div class="fixed w-full z-10 top-0">
        ...
        <!-- main nav -->
        <nav class="bg-gray-50 border-b max-w-8xl mx-auto px-4 sm:px-6 flex items-center justify-between h-10">
          <div class="md:flex items-center sm:hidden">
          ...
          <div class="flew-grow">
            <ul>
              <li class="inline mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="inline text-gray-600 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
